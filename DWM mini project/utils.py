...
LOCAL_DATASET_NAMES = ["Iris (Classification)", "Penguins (Classification)", "Car prices (Regression)"]
LOCAL_PATH_DATASET = ['Datasets/iris.csv', 'Datasets/penguins.csv', 'Datasets/CarPrice.csv']
PYDATASET_NAMES = ["cars",
                   "quakes"]
PYDATASET_DISPLAY_NAMES = ["Speed and Stopping Distances of Cars (Regression)",
...
def max_dist(donnee_apres_pca, df, voisins):  
    distances = []
